...
sealed class TimeUnit{
    data class Day(val days: Int): TimeUnit()
    data class Month(val months: Int): TimeUnit()
    data class Year(val years: Int): TimeUnit()
    data class Hour(val hours: Int): TimeUnit()
    data class Minute(val minute: Int): TimeUnit()
    data class Second(val seconds: Int): TimeUnit()
    data class Nano(val nanosecs: Int): TimeUnit()
}
