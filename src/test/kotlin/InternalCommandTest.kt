...
class InternalCommandTest {
    ...
    fun create() {
        // Given
        // When
        val command = InternalCommand(commandManager, TestGear::testCommand, gear)
    ...
    fun createOptional() {
        // Given
        // When
        val command = InternalCommand(commandManager, TestGear::testCommandOptional, gear)
    ...
    fun createWithUsage() {
        // Given
        // When
        val command = InternalCommand(commandManager, TestGear::testCommandUsage, gear)
